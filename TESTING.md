...
| Tablet (DevTools) | ![screenshot](documentation/testing/responsiveness/responsive-mobile-home.png) | ![screenshot](documentation/testing/responsiveness/responsive-mobile-about.png) | ![screenshot](documentation/testing/responsiveness/responsive-mobile-services.png) | ![screenshot](documentation/testing/responsiveness/responsive-mobile-appointment.png) | ![screenshot](documentation/testing/responsiveness/responsive-mobile-profile.png) | ![screenshot](documentation/testing/responsiveness/responsive-mobile-edit-profile.png) | ![screenshot](documentation/testing/responsiveness/responsive-mobile-register.png) | ![screenshot](documentation/testing/responsiveness/responsive-mobile-login.png) | ![screenshot](documentation/testing/responsiveness/responsive-mobile-404.png) | Works as expected |